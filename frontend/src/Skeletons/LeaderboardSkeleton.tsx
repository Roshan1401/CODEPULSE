      ...
      <div className="mt-5 overflow-hidden rounded-2xl border border-(--color-border) bg-white dark:bg-[#0b0809]">
        ...
        <div className="flex justify-center border-b border-(--color-border) px-6 py-4 md:justify-end">
          <div className="inline-flex items-center gap-2 rounded-xl border border-(--color-border) bg-(--color-bg-secondary) px-4 py-2">
            <div className="h-3 w-3 animate-pulse rounded-full bg-gray-300 dark:bg-neutral-700" />
            <div className="h-4 w-36 animate-pulse rounded bg-gray-300 dark:bg-neutral-700" />
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2 p-3 sm:px-3.5 sm:py-4 md:grid md:grid-cols-12 md:gap-4 md:px-8 md:py-6 lg:px-4 lg:py-8 xl:px-8">
                ...
                <div className="col-span-1 flex">
                  <div className="h-8 w-8 animate-pulse rounded-full bg-gray-300 md:h-9 md:w-9 dark:bg-neutral-700" />
                </div>
                ...
                {/* Mobile Arrow */}
                <div className="h-5 w-5 animate-pulse rounded bg-gray-300 md:hidden dark:bg-neutral-700" />

                {/* Languages — col-span-4, grid ke andar */}
                <div className="col-span-4 hidden justify-end gap-2 md:flex">
                  <div className="h-7 w-14 animate-pulse rounded-md bg-gray-300 dark:bg-neutral-700" />
                  <div className="h-7 w-16 animate-pulse rounded-md bg-gray-300 dark:bg-neutral-700" />
                  <div className="h-7 w-12 animate-pulse rounded-md bg-gray-300 dark:bg-neutral-700" />
                </div>
              </div>
            </div>
          ))}
